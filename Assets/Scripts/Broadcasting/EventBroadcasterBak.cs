 ...
 * Created By: NeilDG
 */
public class EventBroadcasterBak {

	private static EventBroadcasterBak sharedInstance;

	private Dictionary<string, ObserverList> eventObservers;

	public static EventBroadcasterBak Instance {
		get {
			if(sharedInstance == null) {
				sharedInstance = new EventBroadcasterBak();
			}
